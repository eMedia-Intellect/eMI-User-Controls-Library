...
// <copyright company="eMedia Intellect" file="CreateFile.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="CreateFile"/> method.</content>
	internal partial class NewWindow
	{
		/// <summary>Creates a file in the current path of the <see cref="NewWindow.fileSystemBrowserWindow"/> field.</summary>
		private void CreateFile()
		{
			try
			{
				File.Create(FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.nameTextBox.Text)).Dispose();
			...
			{
				if (File.Exists(FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.nameTextBox.Text)))
				{
			...
			{
				if (Directory.Exists(FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.nameTextBox.Text)))
				{
