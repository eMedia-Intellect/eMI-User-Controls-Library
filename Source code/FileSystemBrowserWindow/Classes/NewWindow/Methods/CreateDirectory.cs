...
// <copyright company="eMedia Intellect" file="CreateDirectory.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="CreateDirectory"/> method.</content>
	internal partial class NewWindow
	{
		/// <summary>Creates a directory in the current path of the <see cref="NewWindow.fileSystemBrowserWindow"/> field.</summary>
		private void CreateDirectory()
		{
			try
			{
				Directory.CreateDirectory(FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.nameTextBox.Text));
