...
// <copyright company="eMedia Intellect" file="FileRadioButton_Checked.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="FileRadioButton_Checked"/> method.</content>
	internal partial class NewWindow
	{
		/// <summary>Checks for the existence of a file by the specified name when the radio button is checked.</summary>
