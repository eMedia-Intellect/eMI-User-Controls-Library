...
// <copyright company="eMedia Intellect" file="DeleteDirectories.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="DeleteDirectories"/> method.</content>
	internal partial class DeleteWindow
	{
		/// <summary>Deletes the directories contained in the <see cref="directoryList"/> field.</summary>
