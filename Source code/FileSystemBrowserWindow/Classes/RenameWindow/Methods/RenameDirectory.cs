...
// <copyright company="eMedia Intellect" file="RenameDirectory.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="RenameDirectory"/> method.</content>
	internal partial class RenameWindow
	{
		/// <summary>Renames a directory in the current path of the <see cref="RenameWindow.fileSystemBrowserWindow"/> field.</summary>
		private void RenameDirectory()
		{
			try
			{
				Directory.Move(FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.currentNameTextBox.Text), FileSystemBrowserWindow.PathManipulator.ConcatenatePath(this.fileSystemBrowserWindow.CurrentPath, this.newNameTextBox.Text));
