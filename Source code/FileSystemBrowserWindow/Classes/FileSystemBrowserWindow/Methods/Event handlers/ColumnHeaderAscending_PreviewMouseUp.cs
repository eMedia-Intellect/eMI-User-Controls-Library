...
// <copyright company="eMedia Intellect" file="ColumnHeaderAscending_PreviewMouseUp.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="ColumnHeaderAscending_PreviewMouseUp"/> method.</content>
	public partial class FileSystemBrowserWindow
	{
		/// <summary>Triggers ascending sorting and adds the relevant arrow image to a column header grid when its button is clicked.</summary>
		...
		private void ColumnHeaderAscending_PreviewMouseUp(object sender, MouseButtonEventArgs e)
		{
			...
			this.fileSystemItemSorter.CurrentListSortDirection = ListSortDirection.Ascending;
			...
			switch (currentSortingColumn)
			{
				...
				case SortingColumn.RootDirectory:
					...
					this.rootDirectoryGrid.Children.Add(this.arrowAscendingImage);

					break;
				case SortingColumn.Size:
					this.fileSystemItemSorter.SortSize();

					this.sizeGrid.Children.Add(this.arrowAscendingImage);

					break;
				case SortingColumn.TotalFreeSpace:
					this.fileSystemItemSorter.SortTotalFreeSpace();

					this.totalFreeSpaceGrid.Children.Add(this.arrowAscendingImage);

					break;
				case SortingColumn.TotalSize:
					this.fileSystemItemSorter.SortTotalSize();

					this.totalSizeGrid.Children.Add(this.arrowAscendingImage);

					break;
				case SortingColumn.VolumeLabel:
					this.fileSystemItemSorter.SortVolumeLabel();

					this.volumeGrid.Children.Add(this.arrowAscendingImage);
