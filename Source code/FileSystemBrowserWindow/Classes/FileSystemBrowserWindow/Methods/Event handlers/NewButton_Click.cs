...
// <copyright company="eMedia Intellect" file="NewButton_Click.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="NewButton_Click"/> method.</content>
	public partial class FileSystemBrowserWindow
	{
		/// <summary>Instantiates the <see cref="NewWindow"/> class.</summary>
