...
// <copyright company="eMedia Intellect" file="CreationTimeComparer.cs">
...
namespace Emi.UserControls
{
	...
	/// <content>Contains the <see cref="CreationTimeComparer"/> class.</content>
	public partial class FileSystemBrowserWindow
	{
		/// <summary>Provides a creation time comparer for the <see cref="FileSystemItemSorter"/> class.</summary>
		internal class CreationTimeComparer : IComparer<FileSystemItem>
		{
			/// <summary>The direction by which to sort.</summary>
			private ListSortDirection listSortDirection;

			/// <summary>Initialises a new instance of the <see cref="CreationTimeComparer"/> class.</summary>
			/// <param name="listSortDirection">The direction by which to sort.</param>
			internal CreationTimeComparer(ListSortDirection listSortDirection)
			{
